...
(function() {
  ...
  function displayGameOverMessageOnLose() {
    ...
    if (incorrectlyGuessedLettersCount === 7){
      ...
      var gameOverMessage = "The Correct Word is - '" + currentWord + "'. Better luck next time Lamb Chops.";
  ...
  var hangmanWords = [
    ...
    "variant","inequalities","transferred","hereditary","manorialism","outside","specifically","shellfish","appears","various","embedded",

     "instance","calamity","carpool","perceptible","computer","center","doctor","punishment","notwithstanding","liabilities","feudalism",

     "creative","quickness","conseal","glasses","galaxy","knowledgeable","playground","unqualified","considered","individual ",

     "obtuse","intellectuals","upside","sweet","perception","letter","sandbox","code","pencile",

     "discover","obscure","property","which","laughter","synonyms","abuse","qualifying","crony","formation",

     "screenshots","other","quantom","serfdom","shrewdness","judgments","performing ","operations","personalized",
